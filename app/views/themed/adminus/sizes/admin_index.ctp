<div class="block">
	...
	<div class="block_head">
		...
		<ul>
			<li><?php echo $this->Html->link('Cadastrar Tamanho', array('action' => 'add')); ?></li>
		</ul>
	</div>		<!-- .block_head ends -->
		...
		<?php echo $this->Form->create('Size'); ?>
			...
			<table cellpadding="0" cellspacing="0" width="100%" class="sortable">
				...
				<tbody>
					...
					<tr>
						<td><?php echo $this->Form->input('id.'.$size['Size']['id'], array('type' => 'checkbox', 'div' => false, 'label' => false)); ?></td>
						<td><?php echo $size['Size']['name']; ?>&nbsp;</td>
						<td><?php echo date('d/m/Y H:i:s', strtotime($size['Size']['date'])); ?>&nbsp;</td>
						<td class="delete">
							<?php echo  $this->Html->link('Editar', array('action' => 'edit', $size['Size']['id'])); ?> | 
							<?php echo $this->Html->link('Excluir', array('action' => 'delete', $size['Size']['id']), null, 'Tem certeza que deseja excluir?'); ?></td>
					</tr>
					<?php endforeach; ?>
				</tbody>
