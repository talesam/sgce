		...
		<table cellpadding="0" cellspacing="0" width="100%" class="sortable">
			...
			<tbody>
				...
				<tr>
					...
					<td><?php echo $this->Html->link($estoque[$definicoescesta['Definicoescesta']['id']], array('action' => 'index', 'controller' => 'estoques', $definicoescesta['Definicoescesta']['id'])); ?></td>
					<td class="delete">
